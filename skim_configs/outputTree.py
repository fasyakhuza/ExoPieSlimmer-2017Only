...
st_METXYCorr_Met   = array('f', [0.])
st_METXYCorr_MetPhi= array('f', [0.])
...
st_isSoftLooseIsoMuon = ROOT.std.vector('bool')()
'''
...
st_nTau_DRBased_EleVeto = array('L', [0])
...
temp_floatVecTrackdz = ROOT.std.vector('float')()
temp_floatVecTrackdzError = ROOT.std.vector('float')()
temp_floatVecTrackdxy = ROOT.std.vector('float')()
temp_floatVecTrackdxyError = ROOT.std.vector('float')()
temp_floatVecTrackPt = ROOT.std.vector('float')()
temp_floatVecTrackEta = ROOT.std.vector('float')()
temp_floatVecTrackPhi = ROOT.std.vector('float')()
temp_intVecTrackStatus = ROOT.std.vector('int')()
temp_intVecTrackHighPurity = ROOT.std.vector('int')()
temp_floatVecTrack3Dsignificance = ROOT.std.vector('float')()
temp_floatVecTrackLog10_3Dsig = ROOT.std.vector('float')()

st_THINjetNTracks = ROOT.std.vector('int')()
st_THINjetTrackdz = ROOT.std.vector(ROOT.std.vector('float'))()
st_THINjetTrackdzError = ROOT.std.vector(ROOT.std.vector('float'))()
st_THINjetTrackdxy = ROOT.std.vector(ROOT.std.vector('float'))()
st_THINjetTrackdxyError = ROOT.std.vector(ROOT.std.vector('float'))()
st_THINjetTrackPt = ROOT.std.vector(ROOT.std.vector('float'))()
st_THINjetTrackEta = ROOT.std.vector(ROOT.std.vector('float'))()
st_THINjetTrackPhi = ROOT.std.vector(ROOT.std.vector('float'))()
st_THINjetTrackStatus = ROOT.std.vector(ROOT.std.vector('int'))()
st_THINjetTrackHighPurity = ROOT.std.vector(ROOT.std.vector('int'))()

THINjetTrackMultiplicity = ROOT.std.vector('int')()
THINjet3Dsignificance = ROOT.std.vector(ROOT.std.vector('float'))()
THINjetLog10_of_3Dsignificance = ROOT.std.vector(ROOT.std.vector('float'))()
THINjetAlpha3D = ROOT.std.vector('float')()
THINjetSumTrackPt = ROOT.std.vector('float')()
THINjetSumTrackPt_cutLog10_3Dsig = ROOT.std.vector('float')()
